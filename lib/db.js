...
const FALLBACK_NEON_URL = 'postgresql://neondb_owner:npg_sapwe3BvQ8uD@ep-raspy-wildflower-axx96sbs.c-4.us-east-2.aws.neon.tech/neondb?sslmode=require';
...
function getDbClient() {
  ...
  // If still empty (e.g. on Vercel deployment without env vars configured), use the project Neon Postgres URL
  if (!connectionString || connectionString.trim() === '') {
    connectionString = FALLBACK_NEON_URL;
  }
